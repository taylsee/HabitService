...
namespace HabitService.Business.Interfaces.IServices
{
    ...
    {
        Task<List<UserHabit>> GetUserHabitsAsync(CancellationToken cancellationToken = default);
        Task<UserHabit> AddHabitToUserAsync(Guid habitId, CancellationToken cancellationToken = default);
